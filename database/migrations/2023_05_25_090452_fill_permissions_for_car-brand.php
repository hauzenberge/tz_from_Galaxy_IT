...
class FillPermissionsForCarBrand extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarBrand constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-brand',
            'admin.car-brand.index',
            'admin.car-brand.create',
            'admin.car-brand.show',
            'admin.car-brand.edit',
            'admin.car-brand.delete',
            'admin.car-brand.bulk-delete',
        ]);
